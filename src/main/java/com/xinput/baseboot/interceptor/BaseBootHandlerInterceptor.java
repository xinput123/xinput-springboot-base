 ...
 */
@Component
public class BaseBootHandlerInterceptor extends HandlerInterceptorAdapter {
    ...
    private void securtJwt(HttpServletRequest request, Object object) {
        ...
        result.setCodeWithDefaultMsg(BaseBootError.CLIENT_AUTH_ERROR);
        ...
        try {
            ...
            result.setCodeWithDefaultMsg(BaseBootError.CLIENT_AUTH_TOKEN_EXPIRED);
            unauthorized(result);
            return;
        } catch (Exception e) {
            result.setCodeWithDefaultMsg(BaseBootError.CLIENT_AUTH_ERROR);
